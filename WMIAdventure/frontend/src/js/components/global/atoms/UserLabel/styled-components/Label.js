...
function backColorHandler(theme, term, level, rank, skillPoints) {
...
const Label = styled.div`
  ...
  border-radius: 40px;
  border: 1px solid ${({theme, term, level, rank, skillPoints}) => backColorHandler(theme, term, level, rank, skillPoints)};
